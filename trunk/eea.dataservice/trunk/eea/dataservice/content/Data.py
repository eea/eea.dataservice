...
schema = Schema((
    ...
    LinesField(
        ...
        widget=MultiSelectionWidget(
            ...
            description="The environmenatl reporting obligations used to optain the data. Reporting obligations are requirements to provide information agreed between countries and international bodies such as the EEA or international conventions.",
